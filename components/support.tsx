...
export default function Support() {
  return (
    <div className=" mt-10 py-24 bg-top  bg-[url(https://res.cloudinary.com/dv62ty87r/image/upload/v1761759936/bg_c84ss2.jpg)]  bg-cover relative flex flex-col justify-center bg-fixed">
      {/* overlay */}
